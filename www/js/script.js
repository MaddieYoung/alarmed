...
$(document).ready(function() {
                  ...
                  */
                  ...
                  $("#upminute").click(function() {
                                 if (alarmClock.status === "set"){
                                  alarmClock.alarmMin = alarmClock.alarmMin === 59 ? 0 : alarmClock.alarmMin + 1;                                 setting = setting ===  "mins";
                                 }
                                 });
                  ...
                  $("#downminute").click(function() {
                                         if (alarmClock.status === "set"){
                                         alarmClock.alarmMin = alarmClock.alarmMin === 0 ? 59 : alarmClock.alarmMin - 1;                                 setting = setting ===  "mins";
                                         }
                                         });
